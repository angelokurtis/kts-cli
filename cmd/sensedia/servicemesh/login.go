...
func login(cmd *cobra.Command, args []string) {
	...
	if configMap == nil {
		fmt.Println("the ConfigMap was not found, we'll try with other label")
	...
	fmt.Println("trying to authenticate on " + sensediaManager)
	...
	fmt.Println(oauthProvider + "oauth/authorize?sensedia_auth=" + sensediaAuth + "&xsrf=" + xsrf)
}
